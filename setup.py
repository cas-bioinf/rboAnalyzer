...
if sys.version_info.minor == 4:
    ...
    subset = ['biopython>=1.72, <1.74a0', 'pandas>=0.22, <0.24a0', 'numpy>=1.14, <1.16a0', 'MarkupSafe>=0.23.0, <2.0.0a0', 'kiwisolver>=1.0.1, <1.2']
elif sys.version_info.minor == 5:
    # pip3 install --user "pip>20, <20.2.3" "setuptools>49, <51"
    subset = ['biopython>=1.72, !=1.74, <1.77a0', 'pandas>=0.22, <0.25a0', 'numpy>=1.14, <1.19a0']
elif sys.version_info.minor == 6:
    subset = ['biopython==1.77', 'pandas>=0.22, <1', 'numpy>=1.14, <1.20a0']
elif sys.version_info.minor == 7:
    subset = ['biopython==1.77', 'pandas>=0.22, <1', 'numpy>=1.15, <1.21a0']
elif sys.version_info.minor == 8:
    subset = ['biopython==1.77', 'pandas>=0.22, <1', 'numpy>=1.18, <1.21a0']
else:
    subset = ['biopython>=1.72, !=1.74, <1.78a0', 'pandas>=0.22, <1', 'numpy>=1.14, <2']
